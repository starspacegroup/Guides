...
<SharingMeta
	...
	description="Terms of Service for Guides"
/>
...
<main class="legal-page">
	<div class="legal-container">
		...
		<section class="legal-section">
			...
			<p>
				By accessing or using Guides ("the Service"), you agree to be bound by these Terms of
		...
		<section class="legal-section">
			...
			<p>
				Guides is open-source software. The source code is available under the terms of its
